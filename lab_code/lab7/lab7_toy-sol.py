...
# print(most_probable_features(nb_model, word_vocab, categories, 3))


########## LOGISTIC REGRESSION ##########
lr_sk = LogisticRegression().fit(train_word_features, train_y_data)
a = lr_sk.predict(test_word_features)
print(a)
b = most_influential_features(lr_sk, word_vocab, categories, 6)
print(b)
